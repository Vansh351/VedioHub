...
const Vedios = () => {
  ...
  return (
   ...
   >
     ...
     p={'3'} w={'full'}  overflowY={'auto'} 
       >
       <Heading> Sample Video </Heading>
       <Text>
         Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta reiciendis alias facilis reprehenderit doloribus, nulla blanditiis nam. Esse laboriosam dolorem ut soluta consequuntur sapiente fugit a! Labore recusandae commodi rerum. 
         Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, magni cupiditate doloremque eaque doloribus nulla, expedita molestiae velit totam nihil magnam reprehenderit laboriosam a recusandae consequuntur, voluptate rem at nam.
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore similique nihil placeat! Vitae recusandae, et consectetur odio quo sapiente, corporis sed aperiam ea reprehenderit modi quaerat voluptates illo, quidem quod!
       </Text>
     </VStack>
     </VStack>
